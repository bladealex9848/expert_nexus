"""
Archivo de configuración temporal para Expert Nexus.
Este archivo proporciona configuraciones predefinidas para la aplicación.
"""
...
def setup_config():
    """
    Configura las variables necesarias para la aplicación.
    Esta función se debe llamar al inicio de la aplicación.
    """
    # Configurar OpenAI API Key - Usar variables de entorno o secrets.toml en producción
    ...
    # Configurar Assistant ID - Usar el ID del asistente virtual como predeterminado
    if not os.environ.get("ASSISTANT_ID"):
        os.environ["ASSISTANT_ID"] = "asst_RfRNo5Ij76ieg7mV11CqYV9v"

    # No podemos modificar st.secrets directamente, así que definimos una variable global
    # que será utilizada por la función load_assistants_config
    global ASSISTANTS_CONFIG
    ASSISTANTS_CONFIG = {
        ...
        "asistente_personal": {
            "id": "asst_PAYD2AmBDTTat7F8bpFxOvXg",
            "titulo": "Asistente Profesional de Alexander",
            "descripcion": "Asistente personalizado para necesidades específicas"
        },
        "linguistica": {
    ...
    # No necesitamos configurar otras variables, ya que las hemos configurado como variables de entorno
